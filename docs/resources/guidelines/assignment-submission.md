...
2. Open the assignment file. Click “File” ➜ “Make a copy.”
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/file-make-a-copy.png)
3. Rename the file name.
    ...
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/copy-file.png)
4. After clicking the box under "Folder" in the previous step,
    ...
    - **(5)** Click the arrow. DO NOT CLICK “Select" at this screen.
        - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/choose-folder.png)
5. Click:
    - **(1)** Select
    - **(2)** Make a copy
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/make-a-copy.png)
...
7. Submit it to Canvas
    ...
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/canvas-submission.png)
...
4. Click  "Move."
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/move-file.png)

# [[How to rename a file in Google Drive|ref]]
1. Open the file.
2. Highlight the part you want to change and type.
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/rename-file.png)
...
4. Click "OK".
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/rename-folder.png)

# [[How to post a comment on an assignment|ref]]
1. Go to the assignment page and click "Submission details."
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/canvas-comment.png)
2. Type your comment under  "Add a comment" and click "Save."
    - ![alt text](../../assets/attachments/resources/guidelines/assignment-submission/canvas-comment-saved.png)