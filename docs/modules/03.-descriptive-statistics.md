...
- [Descriptive statistics :lucide-download:](https://docs.google.com/document/d/1sMIb6EWoe2jrRxGgSy9bLbqTh-XcmVIg?rtpof=true&usp=drive_fs){ .md-button .md-button--primary target="_blank" rel="noopener" }
    - See: [[How to submit an assignment]]

### Sample lab assignment  { data-readaloud-exclude }
- [Sample: Descriptive statistics :lucide-download:](https://docs.google.com/document/d/1kPOQtNAASKHCPfOB0u2p_sABd2AaI3hR?rtpof=true&usp=drive_fs){ .md-button .md-button--primary target="_blank" rel="noopener" }

## Reading  { data-readaloud-exclude }
<div class="grid cards" markdown>
- :lucide-book-open:  
[Fisher, Murray J., and Andrea P. Marshall. 2009. “Understanding Descriptive Statistics.” Australian Critical Care 22(2):93–97. doi: 10.1016/j.aucc.2008.11.003.](https://drive.google.com/open?id=1313aMwi3FMDxMoIWgtl8Y95CEwfIWZV9&usp=drive_fs){target="_blank" rel="noopener"}
</div>
...
<!-- slide-break -->
# What is [[variable]] in data wise?
- Any question asked in a survey is a variable, such as:
    - Education, age, gender, income, race/ethnicity, happiness, environmental attitudes, friendship networks, social trust.
<!-- slide-break -->
## [[Types of the variable]]
- Based on the way it is asked and the nature of it; 
    - There are two main types of the [[variable]]s, which are important for data analysis. 
        - They could be:
            1. **Categorical**, or 
            2. **Continuous**.
...
- **[[Working code]]**
    ...
    ```
        ...
        - **Line 3:** We can change the bar color here. Replace the hex color code ➜ `"#336699"`
            - !!! tip "Finding colors"
                - Browse and copy hex color codes at [https://coolors.co/palettes/trending](https://coolors.co/palettes/trending){: target="_blank"}
<!-- slide-break -->
### [[Bar graph]] #output
