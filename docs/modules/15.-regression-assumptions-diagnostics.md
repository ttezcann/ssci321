...
- [Regression analysis assumptions and diagnostics :lucide-download:](https://docs.google.com/document/d/1r6QoRhiBDYWVG7T7kuv9i-ddXVhK8YZu?rtpof=true&usp=drive_fs){ .md-button .md-button--primary target="_blank" rel="noopener" }
...
- :lucide-book-open:  
[Hernán, Miguel A., John Hsu, and Brian Healy. 2019. “A Second Chance to Get Causal Inference Right: A Classification of Data Science Tasks.” Chance 32(1):42–49. doi:10.1080/09332480.2019.1579578.](https://drive.google.com/open?id=1FAbNAqXvEe7llEcbTP5bXRhJGEUi0yLC&usp=drive_fs){target="_blank" rel="noopener"}
</div>
...
- The first two variables are to create `sociallife_index` variable.
    - | Variable name    | Variable label   | Variable type  | Question wording and response categories  |
      ...
      | `life` <br><br> **From:** [**Variables in GSS**](../resources/variables-in-gss.md){: target="_blank"} | Level of finding life exciting | Ordinal, RECODE | In general, do you find life exciting, pretty routine, or dull?<br><br>*(1: Exciting; 2: Routine; 3: Dull)* |
<!-- slide-break -->
