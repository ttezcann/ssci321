...
- [Linear regression :lucide-download:](https://docs.google.com/document/d/1fegt8WmKUImKgOGX8kisYZey2ycousHf?rtpof=true&usp=drive_fs){ .md-button .md-button--primary target="_blank" rel="noopener" }
    - See: [[How to submit an assignment]]

### Sample assignment  { data-readaloud-exclude }
- [Sample: Linear regression :lucide-download:](https://docs.google.com/document/d/1yjJlldaIMzHR3BgdC4qmvafvw9qbZiI3?rtpof=true&usp=drive_fs){ .md-button .md-button--primary target="_blank" rel="noopener" }

## Reading  { data-readaloud-exclude }
<div class="grid cards" markdown>
- :lucide-book-open:  
[Shmueli, Galit. 2010. “To Explain or to Predict?” Statistical Science 25(3):289–310. doi:10.1214/10-STS330.](https://drive.google.com/open?id=1FCevBqd-SEf-s0afbzSRsmLfCJoLtiZZ&usp=drive_fs){target="_blank" rel="noopener"}
</div>
