...
- [Generating a table :lucide-download:](https://docs.google.com/document/d/13BOKMDA_JpU1ItTtZwhRTY9DF-t6-qGb){ .md-button .md-button--primary target="_blank" rel="noopener" }
    - See: [[How to submit an assignment]]

### Sample assignment  { data-readaloud-exclude }
- [Sample: Generating a table :lucide-download:](https://docs.google.com/document/d/1Rb-AlWsyTZBvdEHUtDf_g5deNJ2zLKCE){ .md-button .md-button--primary target="_blank" rel="noopener" }

## Reading  { data-readaloud-exclude }
<div class="grid cards" markdown>
- :lucide-book-open:  
[Verzani, John. 2012. "Overview, Installation." Pp. 1–11 in *Getting started with RStudio*. Sebastopol: O'Reilly.](https://drive.google.com/open?id=1-Re7ytjjVGaHEoUD0Fst2c6GAsA0YCGf&usp=drive_fs){target="_blank" rel="noopener"}
</div>
...
- ![RStudio is open with the Console on the left. The pasted code is highlighted there, with callouts indicating: 1) open the RStudio lab, 2) paste the code into the Console, and 3) press Enter.](../assets/attachments/modules/01.-introduction-to-rstudio/open_rstudio_run_script_codes.png){width="800" }
    1. Open [RStudio Cloud website](https://posit.cloud/){: target="_blank" rel="noopener" } and go to "RStudio labs".
...
- ![RStudio shows the downloaded script file open in the upper-left pane. The Environment pane confirms that the dataset gss is loaded, and the Console shows the file was downloaded successfully.](../assets/attachments/modules/01.-introduction-to-rstudio/final_script_and_gss.png){width="800"}
    ...
    3. When you see a new script file opens and no more code is running, everything is all set.
        - !!! info "Initial setup"
